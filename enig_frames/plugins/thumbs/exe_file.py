...
import enig_frames.services.exe_file



class ExeFile(enig_frames.plugins.base_plugin.BasePlugin):
    def __init__(
            self,
            ...
            exe_service : enig_frames.services.exe_file.ExeFileService =enig.depen(
                enig_frames.services.exe_file.ExeFileService
            )
    ):
        ...
        self.exe_service:enig_frames.services.exe_file.ExeFileService =exe_service
