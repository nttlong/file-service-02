...
def __make_logic__(op, a, b):
    ...
    ret.compiler, is_need_expr = __compiler__(op, a, b)

    ret.use_compare_or_logical_op = __check_compare_or_logical__(a, b) or True
    ret.use_compare_or_logical_op = __check_compare_or_logical__(a, b) or is_need_expr
    ret.use_math_op = __check_math_op__(a, b) or is_need_expr
    return ret
...
def __wrapper_compare_operator__():
    # class FX:
...
def __wrapper_logical_operator__():
    # class FX:
    #     def __le__(self, other):
...
@__wrapper_compare_operator__()
@__wrapper_logical_operator__()
