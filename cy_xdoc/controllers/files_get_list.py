...
def get_list_of_files(app_name:str,FieldSearch:str,PageSize:int,PageIndex:int,token=fastapi.Depends(cy_xdoc.auths.Authenticate))->typing.List[FileUploadRegisterInfo]:
